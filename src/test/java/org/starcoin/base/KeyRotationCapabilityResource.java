...
public final class KeyRotationCapabilityResource {
    public final AccountAddress account_address;

    public KeyRotationCapabilityResource(AccountAddress account_address) {
    ...
    public static KeyRotationCapabilityResource deserialize(com.novi.serde.Deserializer deserializer) throws com.novi.serde.DeserializationError {
    ...
    public static KeyRotationCapabilityResource bcsDeserialize(byte[] input) throws com.novi.serde.DeserializationError {
        if (input == null) {
    ...
    public static final class Builder {
        ...
        public KeyRotationCapabilityResource build() {
            return new KeyRotationCapabilityResource(
                account_address
            );
        }
    }
