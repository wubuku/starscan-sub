...
public final class BlockRewardEvent {
    public final @com.novi.serde.Unsigned Long block_number;
    ...
    public BlockRewardEvent(@com.novi.serde.Unsigned Long block_number, java.math.@com.novi.serde.Unsigned @com.novi.serde.Int128 BigInteger block_reward, java.math.@com.novi.serde.Unsigned @com.novi.serde.Int128 BigInteger gas_fees, AccountAddress miner) {
        java.util.Objects.requireNonNull(block_number, "block_number must not be null");
    ...
    public void serialize(com.novi.serde.Serializer serializer) throws com.novi.serde.SerializationError {
        ...
        serializer.serialize_u64(block_number);
    ...
    public static BlockRewardEvent deserialize(com.novi.serde.Deserializer deserializer) throws com.novi.serde.DeserializationError {
        ...
        builder.block_number = deserializer.deserialize_u64();
    ...
    public boolean equals(Object obj) {
        ...
        if (!java.util.Objects.equals(this.block_number, other.block_number)) { return false; }
        if (!java.util.Objects.equals(this.block_reward, other.block_reward)) { return false; }
        if (!java.util.Objects.equals(this.gas_fees, other.gas_fees)) { return false; }
        if (!java.util.Objects.equals(this.miner, other.miner)) { return false; }
        return true;
    }

    public int hashCode() {
        int value = 7;
        value = 31 * value + (this.block_number != null ? this.block_number.hashCode() : 0);
    ...
    public static final class Builder {
        public @com.novi.serde.Unsigned Long block_number;
