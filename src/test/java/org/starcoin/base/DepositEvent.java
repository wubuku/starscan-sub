...
public final class DepositEvent {
    ...
    public DepositEvent(java.math.@com.novi.serde.Unsigned @com.novi.serde.Int128 BigInteger amount, TokenCode token_code, java.util.List<@com.novi.serde.Unsigned Byte> metadata) {
