...
public abstract class Metadata {
    ...
    public static final class GeneralMetadata extends Metadata {
        public final org.starcoin.base.GeneralMetadata value;

        public GeneralMetadata(org.starcoin.base.GeneralMetadata value) {
        ...
        static GeneralMetadata load(com.novi.serde.Deserializer deserializer) throws com.novi.serde.DeserializationError {
            deserializer.increase_container_depth();
            Builder builder = new Builder();
            builder.value = org.starcoin.base.GeneralMetadata.deserialize(deserializer);
            deserializer.decrease_container_depth();
            return builder.build();
        }
        ...
        public static final class Builder {
            public org.starcoin.base.GeneralMetadata value;
    ...
    public static final class TravelRuleMetadata extends Metadata {
        public final org.starcoin.base.TravelRuleMetadata value;

        public TravelRuleMetadata(org.starcoin.base.TravelRuleMetadata value) {
            java.util.Objects.requireNonNull(value, "value must not be null");
            this.value = value;
        }
        ...
        static TravelRuleMetadata load(com.novi.serde.Deserializer deserializer) throws com.novi.serde.DeserializationError {
            deserializer.increase_container_depth();
            Builder builder = new Builder();
            builder.value = org.starcoin.base.TravelRuleMetadata.deserialize(deserializer);
            deserializer.decrease_container_depth();
            return builder.build();
        }
        ...
        public static final class Builder {
            public org.starcoin.base.TravelRuleMetadata value;
    ...
    public static final class UnstructuredBytesMetadata extends Metadata {
        public final org.starcoin.base.UnstructuredBytesMetadata value;

        public UnstructuredBytesMetadata(org.starcoin.base.UnstructuredBytesMetadata value) {
            java.util.Objects.requireNonNull(value, "value must not be null");
            this.value = value;
        }
        ...
        static UnstructuredBytesMetadata load(com.novi.serde.Deserializer deserializer) throws com.novi.serde.DeserializationError {
            deserializer.increase_container_depth();
            Builder builder = new Builder();
            builder.value = org.starcoin.base.UnstructuredBytesMetadata.deserialize(deserializer);
            deserializer.decrease_container_depth();
            return builder.build();
        }
        ...
        public static final class Builder {
            public org.starcoin.base.UnstructuredBytesMetadata value;
