...
public final class Package {
    ...
    public final Script init_script;

    public Package(AccountAddress package_address, java.util.List<Module> modules, Script init_script) {
    ...
    public static Package deserialize(com.novi.serde.Deserializer deserializer) throws com.novi.serde.DeserializationError {
        ...
        builder.init_script = Script.deserialize(deserializer);
