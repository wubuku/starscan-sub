...
public final class MultiEd25519PublicKey {
    ...
    public static MultiEd25519PublicKey deserialize(com.novi.serde.Deserializer deserializer) throws com.novi.serde.DeserializationError {
    ...
    public static MultiEd25519PublicKey bcsDeserialize(byte[] input) throws com.novi.serde.DeserializationError {
        if (input == null) {
