...
public abstract class WriteSetPayload {
    ...
    public static WriteSetPayload bcsDeserialize(byte[] input) throws com.novi.serde.DeserializationError {
        if (input == null) {
    ...
    public static final class Script extends WriteSetPayload {
        ...
        public final org.starcoin.base.Script script;

        public Script(AccountAddress execute_as, org.starcoin.base.Script script) {
        ...
        static Script load(com.novi.serde.Deserializer deserializer) throws com.novi.serde.DeserializationError {
            ...
            builder.script = org.starcoin.base.Script.deserialize(deserializer);
            deserializer.decrease_container_depth();
            return builder.build();
        }
        ...
        public static final class Builder {
            ...
            public org.starcoin.base.Script script;
