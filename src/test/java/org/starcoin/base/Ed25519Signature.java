...
public final class Ed25519Signature {
    ...
    public static Ed25519Signature deserialize(com.novi.serde.Deserializer deserializer) throws com.novi.serde.DeserializationError {
    ...
    public static Ed25519Signature bcsDeserialize(byte[] input) throws com.novi.serde.DeserializationError {
        if (input == null) {
